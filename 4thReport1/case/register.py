...
class Blog():
    ...
    def register(self):
        ...
        a = str({"mobile":"18883754450","code":"482000","email":"756978382@qq.com","password":"200820e3227815ed1756a6b531e7e0d2","protocol":1,"industry":"农、林、牧、渔业","industryCode":"A","companyName":"sdf"})
        b = a.replace(" ","")
        c = b.replace('\'','\"')
        d = {"args":c}
        print d
